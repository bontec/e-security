...
qvm-ls
\end{verbatim}
For each of these AppVMs the user will be able to set properties like enabling or disabling the connection of the VM to the network, whether files can be copied into it. \todo{find the way to do this,
