...
files can be copied into it. \todo{find the way to do this,
...
dedicated AppVM.}  \todo{uses password salting?, check /etc/shadow}
...
are organised in a three-structured system. \todo{how are the
resources organised in qubes os? is it three-structured system} These
